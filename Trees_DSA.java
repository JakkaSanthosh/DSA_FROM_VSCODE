...
public class Trees_DSA{
    public static void main(String[] args) {
        TreeNode root=null;
        int a[]={2,5,3,7,1,8,6,4};
        for(var i:a) root=insert(root,i);
        TreePrinter<TreeNode> x= new TreePrinter<>(n->""+n.val,n->n.left,n->n.right);
        x.printTree(root);
        List<Integer>outer=lorder(root);
...
public static int print(List<Integer> a){
    return a.get(0);
}
